...
!       & ,rsink_max,msink_max,merge_stars &
  ...
  namelist/nonidealmhd_params/nambipolar,gammaAD &
       ...
       & ,coefad,coefohm, nminitimestep, coefalfven,nmagdiffu2,nambipolar2,nu_sts,coefdtohm
  namelist/pseudovisco_params/nvisco,visco
  namelist/disk_params/Radii0,rho0,rhod0,turb_perc,shear,omega_shear,q_shear,hover_r,ky_0,kz_0,amplitude_pert
  ! fin modif nimhd
#if NDUST>0
  namelist/dust_params/slope_dust,dust_ratio,mrn, size_min, size_max, mrn_index&
       &,vdust_max,update_eint, smalleps,Stokes_number_idust
#endif
  ! Read namelist file
  rewind(1)
...
107 continue
  ...
  rewind(1)
  read(1,NML=pseudovisco_params,END=108)
108 continue
