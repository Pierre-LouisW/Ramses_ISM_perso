...
!       & ,rsink_max,msink_max,merge_stars &
  ...
  namelist/dust_params/grain_size, grain_dens, K_dust, K_drag,dust_diffusion_test,slope_dust,dust_ratio,mrn, size_min, size_max, mrn_index&
       ...
       &,dust_growth,smoluchowski,stepinski,charged_dust_dynamics,v_frag,z_dust, spitzer_charging,ndust_max_mrn, rho_threshold_smol,n_thresold_dust,v_frag,alpha_disk
#endif  
  ! fin modif nimhd
