...
#endif
  real(dp),allocatable,dimension(:)  ::ptcl_size ! Particle size a
!  real(dp),allocatable,dimension(:)  ::ptcl_tracer ! Is particle a tracer and of what fluid (0 for lagrangian else tracer: 1 for gas i-1 for idust)
