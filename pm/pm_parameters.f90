module pm_parameters
  ...
  real(dp)::mass_sink_seed=0                 ! Initial sink mass. If < 0, use the AGN feedback based recipe
  real(dp)::c_acc=-1                         ! "courant factor" for sink accretion time step control.
  ...
  real(dp)::v_max=5d4                       ! Maximum allowed velocity of the AGN blast; in km/s
  real(dp)::v_AGN=1d4                       ! AGN blast velocity; in km/s
  ...
  logical::lagrangian_dust=.false. ! Activate Lagrangian dust particles
