...
#endif                  
#if HALL==1
                  call find_speed_fast(qtmp,cfastLLx,0.0d0)
#else
...
#endif                  
#if HALL==1
                  call find_speed_fast(qtmp,cfastLRx,0.0d0)
#else
...
#if HALL==1
                  call find_speed_fast(qtmp,cfastRLx,0.0d0)
#else
...
#endif                  
#if HALL==1
                  call find_speed_fast(qtmp,cfastRRx,0.0d0)
#else
...
#endif                  
#if HALL==1
                  call find_speed_fast(qtmp,cfastLLy,0.0d0)
#else
...
#endif                  
#if HALL==1
                  call find_speed_fast(qtmp,cfastLRy,0.0d0)
#else
...
#endif                  
#if HALL==1
                  call find_speed_fast(qtmp,cfastRLy,0.0d0)
#else
...
#endif                  
#if HALL==1
                  call find_speed_fast(qtmp,cfastRRy,0.0d0)
#else
