...
! Cosmic rays energy groups
  ...
  real(dp)::floor_E=1d-10   ! Radiative energy floor
  real(dp)::floor_F=1d-10   ! Radiative flux floor
  ...
  real(dp),parameter::Msun=1.9891000e33_dp  !Sun mass in g !TC: todo get rid of this !PLW changed to values from amr/constats/in Rtine
  real(dp),parameter::Rsun=6.9550800e10_dp !Sun radius in cm
  real(dp),parameter::Lsun=3.8280000e33_dp   !Sun luminosity in erg/s
