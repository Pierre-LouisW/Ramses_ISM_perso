...
!#############################################################
!#############################################################
subroutine file_descriptor_rt(filename)
  use amr_commons
  use hydro_commons
  use rt_hydro_commons
  use rt_parameters
  ...
  integer :: idust
#endif  
  if(verbose)write(*,*)'Entering file_descriptor_rt'
  ...
  do ivar=1,nGroups
     write(ilun,'(I2," photon_density_",I1,", d")')nvar+4+ndust*ndim+ivar,ivar
     write(ilun,'(I2," photon_flux_x",I1,", d")')nvar+4+ndust*ndim+ivar+1,ivar
     write(ilun,'(I2," photon_flux_y",I1,", d")')nvar+4+ndust*ndim+ivar+2,ivar
     write(ilun,'(I2," photon_flux_z",I1,", d")')nvar+4+ndust*ndim+ivar+3,ivar
  end do
  close(ilun)
