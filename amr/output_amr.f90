...
subroutine dump_all
  ...
  if(myid==1)then
     ...
     if(hydro)then
        ...
        if(legacy_hydro_file_descriptor)then
           call file_descriptor_hydro(filename)
        else
           call file_descriptor_hydro_main_ramses(filename)
        end if
     end if
  ...
  if(rt.or.neq_chem)then
     ...
     filename=TRIM(filedir)//'rt_file_descriptor.txt'
     if(.not.legacy_hydro_file_descriptor)then
        call file_descriptor_rt(filename)
     end if
  endif
#endif
